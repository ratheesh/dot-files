...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "RosyBrown" :background "gray10" :slant italic))))
 ...
 '(font-lock-string-face ((t (:foreground "#8c8c8c" :slant italic))))
 ...
 '(show-paren-match-face ((t (:background "#181818"))))
