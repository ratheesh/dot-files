...
(custom-theme-set-faces
 ...
 '(font-lock-comment-delimiter-face ((t (:background "gray4" :foreground "bisque4" :slant italic))))
 '(font-lock-comment-face ((t (:background "gray4" :foreground "bisque4" :slant italic))))
 ...
 '(company-tooltip-selection ((((class color) (min-colors 89)) (:background "#2a2a2a"))))
